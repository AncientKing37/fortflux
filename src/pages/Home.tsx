        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose ELITE MP?</h2>
        ...
        <section className="py-20 relative">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-xl mb-10 max-w-2xl mx-auto text-gray-600">
              Whether you're looking to buy a rare Fortnite account or sell your own, ELITE MP makes it safe and simple.
            </p>
