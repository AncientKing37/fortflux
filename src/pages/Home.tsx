...
import { Shield, Wallet, Clock, Check, Search, CircleDollarSign } from 'lucide-react';
...
const Home: React.FC = () => {
  return <div className="min-h-screen bg-black">
      ...
      {/* Stats Section */}
      <section className="py-10 bg-black border-t border-yellow-500/20">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="bg-black p-6 rounded-lg border border-yellow-500/50">
              <p className="text-3xl md:text-4xl font-bold text-yellow-500">10k+</p>
              <p className="text-white mt-2">Active Accounts</p>
            </div>
            <div className="bg-black p-6 rounded-lg border border-yellow-500/50">
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Why Choose EL1TE MARKETPLACE?</h2>
            <p className="text-gray-400 max-w-2xl mx-auto">The safest platform to buy and sell Fortnite accounts with confidence</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-black p-8 rounded-xl border border-yellow-500/50 hover:border-yellow-500 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white group-hover:text-yellow-500 transition-colors">Secure Escrow</h3>
            ...
            <div className="bg-black p-8 rounded-xl border border-yellow-500/50 hover:border-yellow-500 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white group-hover:text-yellow-500 transition-colors">Crypto Payments</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-black p-8 rounded-xl border border-yellow-500/50 hover:border-yellow-500 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white group-hover:text-yellow-500 transition-colors">Verified Accounts</h3>
              <p className="text-gray-400">
            ...
            <div className="bg-black p-8 rounded-xl border border-yellow-500/50 hover:border-yellow-500 transition-all duration-300 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white group-hover:text-yellow-500 transition-colors">Fast Delivery</h3>
              <p className="text-gray-400">
