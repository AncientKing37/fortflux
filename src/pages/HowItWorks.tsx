  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <section className="relative py-20">
        <div className="absolute inset-0 bg-gradient-to-r from-marketplace-blue/30 to-marketplace-purple/30"></div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">How EL1TE MARKETPLACE Works</h1>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800/30 backdrop-blur-md p-8 rounded-xl border border-gray-700/50 text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-marketplace-blue to-marketplace-purple rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <Link to="/signup">
                <Button variant="outline" className="border-marketplace-neon text-marketplace-neon hover:bg-marketplace-neon/10">
                  Get Started
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center mb-24 gap-12">
            <div className="md:w-1/2">
              <div className="bg-gradient-to-r from-marketplace-blue to-marketplace-purple p-1 rounded-lg">
                <div className="bg-gray-900 rounded-lg p-6">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-gray-800 rounded-lg p-4 flex flex-col">
                      <span className="text-marketplace-neon text-sm mb-2">Rare Skins</span>
                      <span className="font-bold text-white">Black Knight</span>
                      <span className="text-gray-400 text-xs">Season 2</span>
                    </div>
                    <div className="bg-gray-800 rounded-lg p-4 flex flex-col">
                      <span className="text-marketplace-neon text-sm mb-2">Account Level</span>
                      <span className="font-bold text-white">350+</span>
                      <span className="text-gray-400 text-xs">Veteran Player</span>
                    </div>
                    <div className="bg-gray-800 rounded-lg p-4 flex flex-col">
                      <span className="text-marketplace-neon text-sm mb-2">Skin Count</span>
                      <span className="font-bold text-white">200+</span>
                      <span className="text-gray-400 text-xs">Full Collection</span>
                    </div>
                    <div className="bg-gray-800 rounded-lg p-4 flex flex-col">
                      <span className="text-marketplace-neon text-sm mb-2">Price</span>
            ...
            <div className="md:w-1/2">
              <div className="flex items-center mb-4">
                <ShoppingBag className="text-marketplace-neon h-6 w-6 mr-3" />
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  <Check className="text-marketplace-neon h-5 w-5 mr-2 mt-1 flex-shrink-0" />
          ...
          <div className="flex flex-col md:flex-row-reverse items-center mb-24 gap-12">
            <div className="md:w-1/2">
              <div className="relative">
                <div className="absolute -inset-1 bg-gradient-to-r from-marketplace-blue to-marketplace-purple rounded-lg blur-sm"></div>
                <div className="relative bg-gray-900 rounded-lg p-6">
                  <div className="flex flex-col space-y-4">
                    <div className="flex justify-between items-center p-4 bg-gray-800 rounded-lg">
                      <div className="flex items-center">
                        <div className="bg-marketplace-neon/20 p-2 rounded-full mr-3">
                          <Shield className="h-6 w-6 text-marketplace-neon" />
                        </div>
                        <div>
                      ...
                      <span className="text-marketplace-neon font-bold">$299.99</span>
                    </div>
                    <div className="flex items-center justify-center space-x-4 p-4 bg-gray-800 rounded-lg">
                      <div className="text-center">
                        ...
                        <div className="w-10 h-10 bg-marketplace-blue rounded-full mx-auto my-2"></div>
                        <p className="text-white font-bold">Player123</p>
                      </div>
                      <div className="flex-1 h-0.5 bg-gradient-to-r from-marketplace-blue via-marketplace-purple to-marketplace-neon"></div>
                      <div className="text-center">
                        <p className="text-sm text-gray-400">Escrow</p>
                        <div className="w-10 h-10 bg-marketplace-purple rounded-full mx-auto my-2"></div>
                        <p className="text-white font-bold">EL1TE</p>
                      </div>
                      <div className="flex-1 h-0.5 bg-gradient-to-r from-marketplace-purple via-marketplace-neon to-marketplace-blue"></div>
                      <div className="text-center">
                        <p className="text-sm text-gray-400">Seller</p>
                        <div className="w-10 h-10 bg-marketplace-neon rounded-full mx-auto my-2"></div>
            ...
            <div className="md:w-1/2">
              <div className="flex items-center mb-4">
                <Shield className="text-marketplace-neon h-6 w-6 mr-3" />
          ...
          <div className="flex flex-col md:flex-row items-center mb-24 gap-12">
            ...
            <div className="md:w-1/2">
              <div className="flex items-center mb-4">
                <Wallet className="text-marketplace-neon h-6 w-6 mr-3" />
          ...
          <div className="flex flex-col md:flex-row-reverse items-center mb-24 gap-12">
                ...
                <div className="flex justify-between items-center mb-6">
                  <div>
                    ...
                    <div className="flex items-center">
                      <div className="flex">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star key={star} className="h-4 w-4 text-marketplace-neon" fill="#10B981" />
                        ))}
                      </div>
                      <span className="text-sm text-gray-400 ml-2">5.0 (124 reviews)</span>
                    </div>
                  </div>
                  <div className="bg-marketplace-neon/20 py-1 px-3 rounded-full">
                    <span className="text-marketplace-neon font-bold text-sm">Trusted Seller</span>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-800 rounded-lg p-4">
                    <div className="flex justify-between mb-2">
                      ...
                      <div className="flex">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <Star key={star} className="h-3 w-3 text-marketplace-neon" fill="#10B981" />
                        ))}
                      </div>
                    </div>
            ...
            <div className="md:w-1/2">
              <div className="flex items-center mb-4">
                <Star className="text-marketplace-neon h-6 w-6 mr-3" />
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="bg-gray-900 rounded-lg overflow-hidden border border-gray-800">
                <div className="bg-gray-800 p-4 border-b border-gray-700">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <div className="w-10 h-10 bg-marketplace-neon rounded-full mr-3"></div>
                      <div>
                ...
                <div className="p-4 h-64 overflow-y-auto">
                  <div className="flex flex-col space-y-3">
                    <div className="flex justify-start">
                      <div className="bg-gray-800 rounded-lg py-2 px-3 max-w-xs">
                    ...
                    <div className="flex justify-end">
                      <div className="bg-marketplace-blue/30 rounded-lg py-2 px-3 max-w-xs">
                        <p className="text-white text-sm">Hey! Yes, it has Black Knight and all season 2 Battle Pass skins. I can show you screenshots if you'd like.</p>
                    ...
                    <div className="flex justify-end">
                      <div className="bg-marketplace-blue/30 rounded-lg py-2 px-3 max-w-xs">
                        <p className="text-white text-sm">The account is level 350+. Been active since Season 1 but I don't play anymore.</p>
                ...
                <div className="bg-gray-800 p-4 border-t border-gray-700">
                  <div className="flex items-center">
                    <input 
                      ...
                      className="flex-1 bg-gray-700 border-none rounded-lg py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-marketplace-neon/50"
                    />
                    <Button size="sm" className="ml-2 bg-marketplace-neon text-gray-900 hover:bg-marketplace-neon/90">
                      Send
                    </Button>
                  </div>
                </div>
            ...
            <div className="md:w-1/2">
              <div className="flex items-center mb-4">
                <MessageSquare className="text-marketplace-neon h-6 w-6 mr-3" />
      ...
      <section className="py-20 relative">
        <div className="absolute inset-0 bg-gradient-to-r from-marketplace-blue/80 to-marketplace-purple/80"></div>
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/signup">
              <Button size="lg" className="bg-marketplace-neon text-gray-900 hover:bg-green-400 text-base font-semibold">
                Create Account
              </Button>
            </Link>
            <Link to="/marketplace">
