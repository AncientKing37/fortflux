          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                <Mail className="h-6 w-6 text-marketplace-neon mr-4" />
                <div>
                  <h3 className="font-bold">Email Us</h3>
                  <p className="text-gray-600">support@fortmarket.demo</p>
                  <p className="text-gray-500 text-sm mt-1">We'll respond within 24 hours</p>
                </div>
              </div>
              
              <div className="flex items-start">
                <Phone className="h-6 w-6 text-marketplace-neon mr-4" />
                <div>
              ...
              <div className="flex items-start">
                <MapPin className="h-6 w-6 text-marketplace-neon mr-4" />
                <div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                <a href="#" className="text-gray-500 hover:text-marketplace-neon transition-colors">
